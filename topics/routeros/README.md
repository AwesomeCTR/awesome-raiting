...
| [PaPerseller/chn-iplist](https://github.com/PaPerseller/chn-iplist) | 997 | 166 | 📝: Chnroutes rules for routers、Shadowrocket、Quantumult、acl、v2rayNG、v2rayN、pac、v2rayA、dae、RouterOS、v2ray、sing-box config file. |
| [tenable/routeros](https://github.com/tenable/routeros) | 862 | 380 | 📝: RouterOS Security Research Tooling and Proof of Concepts |
...
| [ansible-collections/community.routeros](https://github.com/ansible-collections/community.routeros) | 95 | 45 | 📝: Ansible modules for managing MikroTik RouterOS instances. |
...
| [Jamesits/vps2routeros](https://github.com/Jamesits/vps2routeros) | 74 | 40 | 📝: Install RouterOS without screen and keyboard, only Telnet/SSH is required. |
...
| [migotom/mt-bulk](https://github.com/migotom/mt-bulk) | 52 | 11 | 📝: Automate sending mass commands to Mikrotik devices using SSH, SSL API and by REST API gateway. |
...
| [sidiqcahyono83/networkstore-backend](https://github.com/sidiqcahyono83/networkstore-backend) | 0 | 0 | 📝: backend api networkstore |
