...
| [FreeRDP/FreeRDP](https://github.com/FreeRDP/FreeRDP) | 10801 | 14750 | 📝: FreeRDP is a free remote desktop protocol library and clients |
| [mRemoteNG/mRemoteNG](https://github.com/mRemoteNG/mRemoteNG) | 8758 | 1401 | 📝: mRemoteNG is the next generation of mRemote, open source, tabbed, multi-protocol, remote connections manager. |
| [quasar/Quasar](https://github.com/quasar/Quasar) | 8598 | 2439 | 📝: Remote Administration Tool for Windows |
| [m1k1o/neko](https://github.com/m1k1o/neko) | 6904 | 508 | 📝: A self hosted virtual browser that runs in docker and uses WebRTC. |
| [H-M-H/Weylus](https://github.com/H-M-H/Weylus) | 6827 | 272 | 📝: Use your tablet as graphic tablet/touch screen on your computer. |
| [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) | 6414 | 1341 | 📝: RustDesk Server Program |
| [BornToBeRoot/NETworkManager](https://github.com/BornToBeRoot/NETworkManager) | 6339 | 665 | 📝: A powerful tool for managing networks and troubleshoot network problems! |
| [neutrinolabs/xrdp](https://github.com/neutrinolabs/xrdp) | 5600 | 1726 | 📝: xrdp: an open source RDP server |
| [Ylianst/MeshCentral](https://github.com/Ylianst/MeshCentral) | 3973 | 535 | 📝: A complete web-based remote monitoring and management web site. Once setup you can install agents and perform remote desktop session to devices on the local network or over the Internet. |
| [1Remote/1Remote](https://github.com/1Remote/1Remote) | 3953 | 376 | 📝: One Remote Access Manager to Rule Them All |
...
| [kimmknight/remoteapptool](https://github.com/kimmknight/remoteapptool) | 2736 | 367 | 📝: Create and manage RemoteApps hosted on Windows 7, 8, 10, 11, XP and Server. Generate RDP and MSI files for clients. |
| [miroslavpejic85/p2p](https://github.com/miroslavpejic85/p2p) | 2247 | 305 | 📝: 🖥️ P2P Remote Desktop - Portable, No Configuration or Installation Needed. |
| [PhrozenIO/PowerRemoteDesktop](https://github.com/PhrozenIO/PowerRemoteDesktop) | 2123 | 254 | 📝: Remote Desktop entirely coded in PowerShell. |
| [nurdism/neko](https://github.com/nurdism/neko) | 2032 | 185 | 📝: A self hosted virtual browser (rabb.it clone) that runs in docker. |
| [Xpra-org/xpra](https://github.com/Xpra-org/xpra) | 1908 | 164 | 📝: Persistent remote applications for X11; screen sharing for X11, MacOS and MSWindows. |
| [cedrozor/myrtille](https://github.com/cedrozor/myrtille) | 1786 | 375 | 📝: A native HTML4 / HTML5 Remote Desktop Protocol and SSH client |
| [DigitalRuby/IPBan](https://github.com/DigitalRuby/IPBan) | 1619 | 361 | 📝: Since 2011, IPBan is the worlds most trusted, free security software to block hackers and botnets. With both Windows and Linux support, IPBan has your dedicated or cloud server protected. Upgrade to IPBan Pro today and get a discount. Learn more at ↓ |
| [dchapyshev/aspia](https://github.com/dchapyshev/aspia) | 1586 | 339 | 📝: Remote desktop and file transfer tool. |
| [bk138/droidVNC-NG](https://github.com/bk138/droidVNC-NG) | 1308 | 186 | 📝: VNC server app for Android that does not require root privileges. |
| [rdesktop/rdesktop](https://github.com/rdesktop/rdesktop) | 1266 | 364 | 📝: 🚨 rdesktop is in need of a new maintainter. Please see the home page for more details. 🚨 |
| [LibVNC/libvncserver](https://github.com/LibVNC/libvncserver) | 1103 | 483 | 📝: LibVNCServer/LibVNCClient are cross-platform C libraries that allow you to easily implement VNC server or client functionality in your program. |
| [any1/wayvnc](https://github.com/any1/wayvnc) | 1059 | 65 | 📝: A VNC server for wlroots based Wayland compositors |
| [qwqdanchun/DcRat](https://github.com/qwqdanchun/DcRat) | 939 | 329 | 📝: A simple remote tool in C#. |
| [udevbe/greenfield](https://github.com/udevbe/greenfield) | 918 | 28 | 📝: HTML5 Wayland compositor  :seedling:  |
| [scottyhardy/docker-wine](https://github.com/scottyhardy/docker-wine) | 886 | 152 | 📝: Docker image that includes Wine and Winetricks for running Windows applications on Linux and macOS |
| [MirrorX-Desktop/MirrorX](https://github.com/MirrorX-Desktop/MirrorX) | 791 | 50 | 📝: Remote control tool for enterprise, teams and individuals. Build fast and security remote control network with fully control in a short time. |
| [bolkedebruin/rdpgw](https://github.com/bolkedebruin/rdpgw) | 745 | 118 | 📝: Remote Desktop Gateway in Go for deploying on Linux/BSD/Kubernetes |
| [GoogleCloudPlatform/iap-desktop](https://github.com/GoogleCloudPlatform/iap-desktop) | 727 | 166 | 📝: IAP Desktop is a Windows application that provides zero-trust Remote Desktop and SSH access to Linux and Windows VMs on Google Cloud.  |
| [beckzhu/SimpleRemote](https://github.com/beckzhu/SimpleRemote) | 678 | 145 | 📝: Remote Administration Tools |
| [gujjwal00/avnc](https://github.com/gujjwal00/avnc) | 602 | 57 | 📝: VNC Client for Android |
| [Ulterius/server](https://github.com/Ulterius/server) | 596 | 75 | 📝: [WIP] Ulterius™ server where all the magic happens :rocket: :feelsgood: |
...
| [shibayan/ImoutoDesktop](https://github.com/shibayan/ImoutoDesktop) | 101 | 10 | 📝: 「いもうとデスクトップ」はデスクトップ右下に常駐した妹キャラに文字入力でさまざまなお願いをして、他 PC を操作してもらえる対話型のリモート操作ソフトです。 |
...
| [andersevenrud/xpra-html5-client](https://github.com/andersevenrud/xpra-html5-client) | 33 | 10 | 📝: Xpra HTML5 client written in TypeScript |
...
| [Scotchman0/XRDP-for-ubuntu](https://github.com/Scotchman0/XRDP-for-ubuntu) | 12 | 5 | 📝: Automatically installs and configures XFCE, XRDP and variables for a one-script setup |
...
| [LeonarddeR/rd_pipe-rs](https://github.com/LeonarddeR/rd_pipe-rs) | 7 | 0 | 📝: Windows Remote Desktop Services Dynamic Virtual Channel implementation using named pipes, written in Rust |
...
| [samcain1996/RemoteViewer](https://github.com/samcain1996/RemoteViewer) | 4 | 1 | 📝: Application that will let you remote into a linux, windows, or mac. |
...
| [SiebertT/AzureLinuxRDP](https://github.com/SiebertT/AzureLinuxRDP) | 3 | 31 | 📝: How to RDP to Linux Ubuntu servers created on Microsoft Azure with the help of XRDP and desktop environments |
...
| [NextCenturyCorporation/VirtUE](https://github.com/NextCenturyCorporation/VirtUE) | 1 | 0 | 📝: The main repository for the SAVIOR (Secure Applications in Virtual Instantiations of Roles) system |
...
| [0xbythesecond/Configure-AD](https://github.com/0xbythesecond/Configure-AD) | 0 | 1 | 📝: Active Directory centrally manages thousands of user accounts in a single place (accounts, passwords and permissions) as well as manage devices on a large scale. This tutorial outlines the implementation of on-premises Active Directory within Azure Virtual Machines. |
...
| [babakhajizadeh/Linux-Internet-Stabilizer](https://github.com/babakhajizadeh/Linux-Internet-Stabilizer) | 0 | 0 | 📝: Linux Internet stabilizer can reconnect you back to Internet automatically in case of connection loss. Useful when connection persistency is required; e.g. for Remote Desktop |
