...
| [nrlquaker/winbox-mac](https://github.com/nrlquaker/winbox-mac) | 1438 | 145 | 📝: MikroTik Winbox bundled into macOS app with Wine |
...
| [casterbyte/NetworkNightmare](https://github.com/casterbyte/NetworkNightmare) | 716 | 78 | 📝: Network Pentesting Mindmap |
| [talkincode/toughradius](https://github.com/talkincode/toughradius) | 560 | 272 | 📝:  toughradius provides radius server, tr069 acs |
| [nshttpd/mikrotik-exporter](https://github.com/nshttpd/mikrotik-exporter) | 550 | 153 | 📝: prometheus mikrotik device(s) exporter |
| [beeyev/Mikrotik-RouterOS-automatic-backup-and-update](https://github.com/beeyev/Mikrotik-RouterOS-automatic-backup-and-update) | 430 | 83 | 📝: Script sends backups to email and keep your mikrotik firmware up to date. |
| [lisenet/kubernetes-homelab](https://github.com/lisenet/kubernetes-homelab) | 410 | 115 | 📝: Building a multi-master multi-node Kubernetes homelab with kubeadm, Ansible, Helm and Terraform. |
| [EvilFreelancer/routeros-api-php](https://github.com/EvilFreelancer/routeros-api-php) | 396 | 146 | 📝: Mikrotik RouterOS API PHP client for your applications |
| [haakonnessjoen/MAC-Telnet](https://github.com/haakonnessjoen/MAC-Telnet) | 391 | 125 | 📝: Open source MAC Telnet client and server for connecting to Mikrotik RouterOS routers and Posix devices using MAC addresses |
| [laksa19/mikhmonv3](https://github.com/laksa19/mikhmonv3) | 375 | 254 | 📝: MikroTik Hotspot Monitor V3 [MikroTik API PHP] |
| [EvilFreelancer/docker-routeros](https://github.com/EvilFreelancer/docker-routeros) | 355 | 126 | 📝: Mikrotik RouterOS inside Docker container |
| [tomaae/homeassistant-mikrotik_router](https://github.com/tomaae/homeassistant-mikrotik_router) | 301 | 50 | 📝: Mikrotik router integration for Home Assistant |
| [IgorKha/Grafana-Mikrotik](https://github.com/IgorKha/Grafana-Mikrotik) | 291 | 58 | 📝: 🔰 Grafana dashboard for Mikrotik/routerOS [Prometheus, SNMP] |
| [tarampampam/mikrotik-hosts-parser](https://github.com/tarampampam/mikrotik-hosts-parser) | 248 | 75 | 📝: ✂ Mikrotik hosts parser |
| [pear2/Net_RouterOS](https://github.com/pear2/Net_RouterOS) | 241 | 115 | 📝: This package allows you to read and write information from a RouterOS host using the MikroTik RouterOS API protocol. |
| [M0r13n/mikrotik_monitoring](https://github.com/M0r13n/mikrotik_monitoring) | 241 | 33 | 📝: Monitor your Mikrotik router with Prometheus and Grafana |
| [Trakkasure/mikronode](https://github.com/Trakkasure/mikronode) | 241 | 97 | 📝: Mikrotik API for Node |
| [luqasz/librouteros](https://github.com/luqasz/librouteros) | 221 | 50 | 📝: Python implementation of MikroTik RouterOS API |
| [misterkrittin/Scripts-MikroTik](https://github.com/misterkrittin/Scripts-MikroTik) | 220 | 104 | 📝: My Certificates are MTCNA, MTCUME, and MTCSE. 🙂 |
| [SadeghHayeri/Mili](https://github.com/SadeghHayeri/Mili) | 203 | 19 | 📝: Mili is an open source tool for auto login hotspot pages! (MacOS + Linux) |
| [mriza/winbox-installer](https://github.com/mriza/winbox-installer) | 193 | 72 | 📝: Install winbox in fedora/ubuntu linux, using wine |
| [tenable/router_badusb](https://github.com/tenable/router_badusb) | 190 | 35 | 📝: BadUSB in Routers |
| [vzakharchenko/keycloak-radius-plugin](https://github.com/vzakharchenko/keycloak-radius-plugin) | 188 | 45 | 📝: Make the radius server as part of keycloak SSO |
| [Disassembler0/mikrotik-scripts](https://github.com/Disassembler0/mikrotik-scripts) | 182 | 47 | 📝: Set of various administrative scripts, tips and tricks for MikroTik |
| [Vadims06/topolograph](https://github.com/Vadims06/topolograph) | 175 | 22 | 📝: Topolograph.com is an online project which can visualize OSPF/ISIS topology based on LSDB output from a single network device. Then you can not only see (and check) the shortest path from source to destination, but also see the outcome from link or node failure along the path to the destination.  |
| [danikf/tik4net](https://github.com/danikf/tik4net) | 174 | 93 | 📝: Manage mikrotik routers with .NET C# code via ADO.NET like API or enjoy O/R mapper like highlevel api. |
| [ibnux/phpmixbill](https://github.com/ibnux/phpmixbill) | 160 | 112 | 📝: PHP Mikrotik Billing - Voucher management for Mikrotik Hotspot |
...
| [0x802/MikrotikSploit](https://github.com/0x802/MikrotikSploit) | 153 | 44 | 📝: MikrotikSploit is a script that searches for and exploits Mikrotik network vulnerabilities |
| [ivanalayan15/JuanFi](https://github.com/ivanalayan15/JuanFi) | 153 | 117 | 📝: Juanfi is an open source system for coinslot integration for mikrotik hotspot |
| [pwlgrzs/Mikrotik-Blacklist](https://github.com/pwlgrzs/Mikrotik-Blacklist) | 148 | 31 | 📝: Mikrotik friendly blacklist to filter all these damn hackers. |
| [beeyev/Mikrotik-Duckdns-Dynamic-IP-Updater](https://github.com/beeyev/Mikrotik-Duckdns-Dynamic-IP-Updater) | 144 | 26 | 📝: Mikrotik script to automatically update DuckDNS.org’s dynamic DNS service with your public IP address. |
| [miladdiaz/MikrotikExploit](https://github.com/miladdiaz/MikrotikExploit) | 143 | 64 | 📝: Scan and Export RouterOS Password |
| [Lillecarl/ROS_Scripts](https://github.com/Lillecarl/ROS_Scripts) | 114 | 26 | 📝: Scripts for RouterOS (MikroTik devices) |
...
| [Eigenrouter/eigenrouter](https://github.com/Eigenrouter/eigenrouter) | 48 | 9 | 📝: Detailed how-to information about setting up Internet, IPTV & VoIP on your own router from different ISPs |
...
| [troke12/MikrotikToDiscord](https://github.com/troke12/MikrotikToDiscord) | 23 | 14 | 📝: Monitoring your mikrotik from your discord |
...
| [edgenative/mikrotik-irrupdater](https://github.com/edgenative/mikrotik-irrupdater) | 11 | 2 | 📝: Scripts to automatically deploy strict IRR filters to your peers on Mikrotik routers. |
...
| [elmaxid/Fastnetmon-MikroTik-Plugin](https://github.com/elmaxid/Fastnetmon-MikroTik-Plugin) | 8 | 2 | 📝: MikroTik FastNetMon plugin |
...
| [gmaniel/Mikrotik-RouterOS](https://github.com/gmaniel/Mikrotik-RouterOS) | 6 | 0 | 📝: This repository is for managing scripts for Mikrotik RouterOS |
...
| [Jorge-FS/RouterOS-full-manager](https://github.com/Jorge-FS/RouterOS-full-manager) | 4 | 2 | 📝: Complete administration of multiple devices with RouterOS, add PPPoe users and manage suspended devices. |
...
| [megabitus98/megalert](https://github.com/megabitus98/megalert) | 2 | 0 | 📝: a Flask-based, API-centric system to send SMS using a Mikrotik device with LTE capabilities |
...
| [MinistrBob/MikrotikBackup](https://github.com/MinistrBob/MikrotikBackup) | 2 | 1 | 📝: Python program for backup Mikrotiks |
...
| [mchevro/Python-MikrotikAutomation](https://github.com/mchevro/Python-MikrotikAutomation) | 1 | 1 | 📝: Mikrotik Automation Dengan Python |
...
| [natho19/mikrotik](https://github.com/natho19/mikrotik) | 0 | 0 | 📝: Conception, intégration et développement des pages du mikrotik |
| [9d4/mhu](https://github.com/9d4/mhu) | 0 | 0 | 📝: Mikrotik Hotspot User. Bulk import |
| [Max13/Cours](https://github.com/Max13/Cours) | 0 | 0 | 📝: Cours publiques |
| [wmdru/opencart-v1-plugin](https://github.com/wmdru/opencart-v1-plugin) | 0 | 2 | 📝: No description |
...
| [akoharu/simple-isolir-page](https://github.com/akoharu/simple-isolir-page) | 0 | 0 | 📝: Simple isolir page with contact form |
| [jorgediasdsg/mikrotik-backup-update](https://github.com/jorgediasdsg/mikrotik-backup-update) | 0 | 0 | 📝: No description |
| [MarceloWatson/scripts](https://github.com/MarceloWatson/scripts) | 0 | 0 | 📝: No description |
| [Wofbit/Mikrotik_Eve-ng](https://github.com/Wofbit/Mikrotik_Eve-ng) | 0 | 0 | 📝: Install Mikrotik Images On EVE-NG |
| [mamashin/mkr-to-zbx](https://github.com/mamashin/mkr-to-zbx) | 0 | 0 | 📝: Auto discovering and adding hosts to Zabbix from Mikrotik |
| [AngelusGi/Mikrotik](https://github.com/AngelusGi/Mikrotik) | 0 | 0 | 📝: Mikrotik scripts |
| [unattended-ch/logv](https://github.com/unattended-ch/logv) | 0 | 0 | 📝: IIS, Nginx, Apache and Mikrotik Logfile anlysis |
| [cosandr/homelab](https://github.com/cosandr/homelab) | 0 | 0 | 📝: No description |
...
| [nagytoth1/oprendszerek_beadando](https://github.com/nagytoth1/oprendszerek_beadando) | 0 | 0 | 📝: Beadandó projektmunka Korszerű operációs rendszerek tárgyra |
| [gstolarz/drone-mikrotik](https://github.com/gstolarz/drone-mikrotik) | 0 | 0 | 📝: Drone MikroTik Plugin |
...
| [b4k0/gns3Networks](https://github.com/b4k0/gns3Networks) | 0 | 0 | 📝: GNS3 projects for OSPF-BGP & VLAN |
| [amolood/phpnuxbill-users-data-usage-plugin](https://github.com/amolood/phpnuxbill-users-data-usage-plugin) | 0 | 0 | 📝: No description |
| [rakibpnet/IP_ADDRESS](https://github.com/rakibpnet/IP_ADDRESS) | 0 | 0 | 📝: IP Address list for spesefic website and application. |
| [backslash7/nagios-plugins](https://github.com/backslash7/nagios-plugins) | 0 | 0 | 📝: Various extra plugins for Nagios |
| [410g0n3/firewall-rules](https://github.com/410g0n3/firewall-rules) | 0 | 0 | 📝: Reglas de firewall para routers Mikrotik para limitar el tráfico de servicios streaming. |
...
| [Haw41k/gw-switch](https://github.com/Haw41k/gw-switch) | 0 | 1 | 📝: небольшой сервис для быстрого переключения маршрутов средствами маршрутизатора под управлением RouterOS |
| [no-name977/network_automations_code](https://github.com/no-name977/network_automations_code) | 0 | 0 | 📝: aplikasi yang dibuat menggunakan bahasa pemgrograman python dan dijalan menggunkan flask. data yang diambil juga menggunakan router api akan tetapi untuk ssh olt hanya code nya saja blm diimplementasikan dikarenakn blm ada bahan riset untuk menlanjut kan code program nya |
| [alirezkarami/mikrotik_for_linux](https://github.com/alirezkarami/mikrotik_for_linux) | 0 | 0 | 📝: No description |
| [lifeismycampus/jekyll_old](https://github.com/lifeismycampus/jekyll_old) | 0 | 0 | 📝: Official repository for web blog: Life is My Campus |
| [3dot/chr_aws-ami](https://github.com/3dot/chr_aws-ami) | 0 | 0 | 📝: AWS AMI for Mikrotik RouterOS CHR |
| [safrinnetwork/MikWaBot](https://github.com/safrinnetwork/MikWaBot) | 0 | 0 | 📝: MikroTik WhatsApp Bot adalah bot WhatsApp yang terhubung dengan perangkat MikroTik menggunakan REST API |
| [Koubek/Koubek.Mikrotik.WiFi-Shutdown](https://github.com/Koubek/Koubek.Mikrotik.WiFi-Shutdown) | 0 | 1 | 📝: Script for Mikrotik routerboards that will control WIFI daily shutdown/startup process. |
| [messerdos/suri-labs](https://github.com/messerdos/suri-labs) | 0 | 1 | 📝: Virtual lab for suricata tests |
| [icarrr/superhero](https://github.com/icarrr/superhero) | 0 | 0 | 📝: No description |
| [andy03kr/mikrotik](https://github.com/andy03kr/mikrotik) | 0 | 0 | 📝: No description |
| [kmarzic/openwrt_mikrotik_cap_ac](https://github.com/kmarzic/openwrt_mikrotik_cap_ac) | 0 | 0 | 📝: openwrt mikrotik cap ac firmware |
| [syahrulrzk/MIkrotik](https://github.com/syahrulrzk/MIkrotik) | 0 | 0 | 📝: Mikrotik adalah sistem operasi berbasis Linux yang digunakan untuk router jaringan. Mikrotik dirancang untuk memberikan kemudahan bagi penggunanya. |
| [nickarellano/ansible-execution-environments](https://github.com/nickarellano/ansible-execution-environments) | 0 | 0 | 📝: This repository goes along with the linked blog post. In this repository we cover creating a new execution environment for RouterOS and test the environment with ansible-runner before pushing to Private Automation Hub. |
| [timerke/mikrotik_routers](https://github.com/timerke/mikrotik_routers) | 0 | 0 | 📝: Application for mass filter settings on MikroTik routers |
| [mepley1/mikrotik](https://github.com/mepley1/mikrotik) | 0 | 0 | 📝: Mikrotik RouterOS scripts and tools |
| [Orhideous/thangail](https://github.com/Orhideous/thangail) | 0 | 0 | 📝: Geofencing helper for Mikrotik |
...
| [Qeteshpony/MikroTikLEDs](https://github.com/Qeteshpony/MikroTikLEDs) | 0 | 0 | 📝: Switch port LEDs on a MikroTik device |
| [VarnaLab/whoisatvarnalab-cli](https://github.com/VarnaLab/whoisatvarnalab-cli) | 0 | 0 | 📝: This is a simple command line nodejs application which shows active dhcp clients for a mikrotik router. |
| [GOID1989/mediawiki-mikrotik-table](https://github.com/GOID1989/mediawiki-mikrotik-table) | 0 | 0 | 📝: Mediawiki tag extension allow adding Mikrotik/ROS info on page |
| [tenhishadow/mikrotik_scripts](https://github.com/tenhishadow/mikrotik_scripts) | 0 | 0 | 📝: some script to automate routine |
| [diamonjack/LoadBallancing-Mikrotik](https://github.com/diamonjack/LoadBallancing-Mikrotik) | 0 | 1 | 📝: LoadBallancing Mikrotik PCC |
| [ebarkie/routeros-scripts](https://github.com/ebarkie/routeros-scripts) | 0 | 0 | 📝: Mikrotik RouterOS scripts. |
| [rollopack/MikroTik-Mass-Updater](https://github.com/rollopack/MikroTik-Mass-Updater) | 0 | 0 | 📝: Perl script to send commands to a Mikrotik list via SSH |
| [afsharsafavi/Firewall_CIDR](https://github.com/afsharsafavi/Firewall_CIDR) | 0 | 0 | 📝: Findout CIDR of your country or ISP to add them in your IPTables or Mikrotik as a Whitelist |
| [hotspotbilling/phpnuxbill-bkash](https://github.com/hotspotbilling/phpnuxbill-bkash) | 0 | 1 | 📝: Payment Gateway bKash |
| [RanggaBS/amphibious](https://github.com/RanggaBS/amphibious) | 0 | 1 | 📝: Custom MikroTik hotspot page with clean design. |
| [BetterCorp/ssh-commander](https://github.com/BetterCorp/ssh-commander) | 0 | 0 | 📝: Log into multiple mikrotik routers and does stuff |
| [h0tbird/mikrotik](https://github.com/h0tbird/mikrotik) | 0 | 0 | 📝: Mikrotik RouterOS configuration |
| [kathy30094/selenium](https://github.com/kathy30094/selenium) | 0 | 0 | 📝: selenium functions |
| [sinichi449/Android-BurstLimitCalculator](https://github.com/sinichi449/Android-BurstLimitCalculator) | 0 | 0 | 📝: Simple apps to calculate Burst Queue on Mikrotik |
| [KolesovDV/mikrotik_backup](https://github.com/KolesovDV/mikrotik_backup) | 0 | 0 | 📝: Mikrotik backup configuration and upload to ftp server |
| [DanilovSoft/LetsEncryptMikroTik](https://github.com/DanilovSoft/LetsEncryptMikroTik) | 0 | 0 | 📝: No description |
| [TKJ-FAMILY/Putrapakuan-Mikrotik-Hotspot-Theme-v4](https://github.com/TKJ-FAMILY/Putrapakuan-Mikrotik-Hotspot-Theme-v4) | 0 | 0 | 📝: Tema versi 4 adalah tema yang hadir dengan versi desain yang minimalis dan modern dengan beberapa pilihan warna tema yang tersedia |
| [D13410N3/mikrotik_prometheus_exporter](https://github.com/D13410N3/mikrotik_prometheus_exporter) | 0 | 0 | 📝: Simple exporter for Mikrotik written in PHP (lol) |
...
| [muktirandy/mikrotik-config-to-csv](https://github.com/muktirandy/mikrotik-config-to-csv) | 0 | 0 | 📝: Mikrotik Firewall Config to CSV |
| [candil07/Aplikasi-Hotspot-Mikrotik](https://github.com/candil07/Aplikasi-Hotspot-Mikrotik) | 0 | 0 | 📝: Download Source Code Aplikasi Voucer Hotspot Gratis: https://code.candilkuya.com/2021/10/mikmos-cms-untuk-membuat-voucher-hotspot.html |
| [mzorbas/MikrotikScripts](https://github.com/mzorbas/MikrotikScripts) | 0 | 0 | 📝: No description |
| [ngangavic/ros-rest-php](https://github.com/ngangavic/ros-rest-php) | 0 | 0 | 📝: RouterOS 7 (REST API) example in PHP |
| [darshankowlaser/dionysus](https://github.com/darshankowlaser/dionysus) | 0 | 0 | 📝: Deploying MikroTIk Configuration At Scale |
...
| [Sonny14/MikroTik-study-guides](https://github.com/Sonny14/MikroTik-study-guides) | 0 | 0 | 📝: This repository is intended for educational purposes only.  |
| [tmcdos/static-dhcp](https://github.com/tmcdos/static-dhcp) | 0 | 0 | 📝: Simple web form for static assignment of DHCP leases |
| [saidursumon96/Mikrotik-Router-and-Server-Configuration](https://github.com/saidursumon96/Mikrotik-Router-and-Server-Configuration) | 0 | 0 | 📝: No description |
| [swoga/MikrotikExporter.Net](https://github.com/swoga/MikrotikExporter.Net) | 0 | 0 | 📝: Prometheus Exporter for MikroTik devices |
| [a-elmohamady/WiFi-Admin](https://github.com/a-elmohamady/WiFi-Admin) | 0 | 0 | 📝: Application to manage public Wi-Fi networks Power by microsystem hotspot |
| [Vlad1mir-D/routeros-6-source](https://github.com/Vlad1mir-D/routeros-6-source) | 0 | 0 | 📝: Mikrotik RouterOS 6 GPL'ed source |
| [igorpaula7/move-files-with-python](https://github.com/igorpaula7/move-files-with-python) | 0 | 0 | 📝: Copiar os LOGS do MiKrotik Syslog Daemon e colocar em uma pasta segura, utilizando Python |
| [ViToni/mikrotik-ui](https://github.com/ViToni/mikrotik-ui) | 0 | 0 | 📝: A REST based UI for MikroTik routers based on Vue / Quasar |
...
| [sabueso/mk-ovpn-gen](https://github.com/sabueso/mk-ovpn-gen) | 0 | 0 | 📝: An Ansible role used to generate all the nasty Openvpn files for Mikrotik |
| [Mehonoshin/mikrotik-cheatsheet](https://github.com/Mehonoshin/mikrotik-cheatsheet) | 0 | 0 | 📝: HOWTOs for RouterOS |
| [pooriaghaedi/pymik](https://github.com/pooriaghaedi/pymik) | 0 | 1 | 📝: Automate Mikrotik administration using python. |
| [null31/zabbix-templates](https://github.com/null31/zabbix-templates) | 0 | 0 | 📝: Zabbix templates for some network devices. Currently supports only MikroTik. |
...
| [pkgstore-old/mikrotik-cfg-rsc](https://github.com/pkgstore-old/mikrotik-cfg-rsc) | 0 | 0 | 📝: No description |
...
| [Alireza2n/MikrotikIPAccountingTimeSeries](https://github.com/Alireza2n/MikrotikIPAccountingTimeSeries) | 0 | 0 | 📝: An app that gathers and saves Mikrotik IP Accounting data to QuestDB (a timeseries DB) |
| [Luksamarilla/FILTER-RULES-BASIC_MIKROTIK](https://github.com/Luksamarilla/FILTER-RULES-BASIC_MIKROTIK) | 0 | 0 | 📝: FILTER RULES EVIT PING  FLOOD |
| [evan4yoo/OxidizedPoller](https://github.com/evan4yoo/OxidizedPoller) | 0 | 0 | 📝: Adding (MikroTik) devices to oxidized auto-magically |
...
| [isx47590131/radius](https://github.com/isx47590131/radius) | 0 | 0 | 📝: Sistema radius per autenticació de dispositius de xarxa || Projecte radius amb validació ldap a Mikrotik |
| [Aztek1337/MikroTik_Backup](https://github.com/Aztek1337/MikroTik_Backup) | 0 | 0 | 📝: Shell script to create and pull MikroTik backup's to a server |
| [imyhacker/WINS](https://github.com/imyhacker/WINS) | 0 | 0 | 📝: Helper Winbox Installer For Linux  |
| [littlekura/Mikrotik-Script](https://github.com/littlekura/Mikrotik-Script) | 0 | 0 | 📝: Mikrotik Script |
...
| [bdsach/hotspot](https://github.com/bdsach/hotspot) | 0 | 0 | 📝: Login page hotspot for Mikrotik |
| [litew/mikrotik-unbound](https://github.com/litew/mikrotik-unbound) | 0 | 0 | 📝: Unbound resolver for MikroTik routers |
| [litew/mikrotik-hindsight](https://github.com/litew/mikrotik-hindsight) | 0 | 0 | 📝: Hindsight log engine for MikroTik routers |
...
| [wmdru/opencart-v2-plugin](https://github.com/wmdru/opencart-v2-plugin) | 0 | 2 | 📝: Plugin for OpenCart v2 to work with wmd.ru API. |
...
| [j2ghz/prometheus_mikrotik_exporter](https://github.com/j2ghz/prometheus_mikrotik_exporter) | 0 | 0 | 📝: WIP Mikrotik Accounting Exporter for Prometheus https://wiki.mikrotik.com/wiki/Manual:IP/Accounting |
| [torturelabs/routerbkp](https://github.com/torturelabs/routerbkp) | 0 | 0 | 📝: Simple RouterBOARD backup tool |
...
| [kholisx/mikrotik-hotspot-forgot-password](https://github.com/kholisx/mikrotik-hotspot-forgot-password) | 0 | 1 | 📝: Just a simple MikroTik Hotspot Forgot Password using MikroTik PHP Class |
| [gponcemdp/mikrotik](https://github.com/gponcemdp/mikrotik) | 0 | 1 | 📝: Blacklists for Mikrotik RouterOS compiled from Spamhaus DROP and EDROP lists. |
| [WiFiColombia/Backup_Email_Mikrotik](https://github.com/WiFiColombia/Backup_Email_Mikrotik) | 0 | 0 | 📝: Sistema para realizar script de backup vía email |
| [pablo-de/mikrotik](https://github.com/pablo-de/mikrotik) | 0 | 0 | 📝: Scripts de utilidad para RouterOS Mikrotik |
| [TKJ-FAMILY/Putrapakuan-Mikrotik-Hotspot-Theme-v5](https://github.com/TKJ-FAMILY/Putrapakuan-Mikrotik-Hotspot-Theme-v5) | 0 | 0 | 📝: Tema versi 5 Meneruskan desain dari versi sebelumnya namun dengan tambahan banyak fitur dan framework yang menjadikannya lebih nyaman digunakan |
| [taehyunnkim/gomt](https://github.com/taehyunnkim/gomt) | 0 | 0 | 📝: :mag: GOMikroTik - A Mikrotik device monitor |
| [Easen/mikrotik-routeros-duckdns-ipv6-advertise](https://github.com/Easen/mikrotik-routeros-duckdns-ipv6-advertise) | 0 | 0 | 📝: Mikrotik DuckDNS IPv6 - Using Advertise Interface's IPv6 Address |
| [WillNilges/ospf2zabbix](https://github.com/WillNilges/ospf2zabbix) | 0 | 0 | 📝: A simple Python program to ingest OSPF data from NYC Mesh and configure Zabbix monitoring |
...
| [GregoryGost/MikroTik](https://github.com/GregoryGost/MikroTik) | 0 | 0 | 📝: MikroTik scripts, settings, etc. |
| [kochrg/mikrotik_vpn_report](https://github.com/kochrg/mikrotik_vpn_report) | 0 | 0 | 📝: Automatically creates a report with the connection information about the users that are connecting to a L2TP-VPN through a MikroTik router. |
...
| [PetrJandl/MikrotikBackupScript](https://github.com/PetrJandl/MikrotikBackupScript) | 0 | 0 | 📝: Script for automatic backup many Mikrotics |
| [saidlm/Mikrotik_scripts](https://github.com/saidlm/Mikrotik_scripts) | 0 | 0 | 📝: No description |
...
| [altucor/http-knocker](https://github.com/altucor/http-knocker) | 0 | 0 | 📝: http-knocker allows to open port by visiting secret URL. |
| [mhmdnurulkarim/My-Hotspot](https://github.com/mhmdnurulkarim/My-Hotspot) | 0 | 0 | 📝: Hotspot For Mikrotik at My Home |
| [natmanglemikrotik/template-hotspot-mikrotik-asli](https://github.com/natmanglemikrotik/template-hotspot-mikrotik-asli) | 0 | 0 | 📝: natmangleid |
...
| [jefersonaraujo/ProviderInternet](https://github.com/jefersonaraujo/ProviderInternet) | 0 | 1 | 📝: Repositorio de Script para Radios e Mikrotik |
| [bartmichu/mikrotik-scripts](https://github.com/bartmichu/mikrotik-scripts) | 0 | 1 | 📝: Various MikroTik / RouterOS scripts |
| [mik9/headerless](https://github.com/mik9/headerless) | 0 | 0 | 📝: Simple proxy for environments where you can do HTTP requests but it's hard or imposible to use HTTP headers (like Mikrotik Router OS). |
| [cutiful/ros-geoaccounting](https://github.com/cutiful/ros-geoaccounting) | 0 | 1 | 📝: A tool to see where traffic from your Mikrotik is going |
...
| [rodriSDK/mikrotik-scripts-spanish](https://github.com/rodriSDK/mikrotik-scripts-spanish) | 0 | 0 | 📝: Mis avances de recopilación de conocimiento relacionado con diferentes tipos de actividades en Mikrotik.  |
| [Haris-Alsaman/Hostpot-Sessions-Mikrotik](https://github.com/Haris-Alsaman/Hostpot-Sessions-Mikrotik) | 0 | 0 | 📝: Hotspot Sessions |
| [VarnaLab/varnalab-cli](https://github.com/VarnaLab/varnalab-cli) | 0 | 1 | 📝: VarnaLab CLI Tool |
| [antilax-3/docker-mikrotikexporter](https://github.com/antilax-3/docker-mikrotikexporter) | 0 | 0 | 📝: No description |
| [just1689/silent-k8s-cluster](https://github.com/just1689/silent-k8s-cluster) | 0 | 0 | 📝: Build a Kubernetes cluster on Ubuntu silently |
| [backdoordhaka/backdoordhaka.github.io](https://github.com/backdoordhaka/backdoordhaka.github.io) | 0 | 0 | 📝: Backdoor is a fast growing IT and Technology based IT Professional Group. Everyone will get their own IT-based services and solutions. We will learn not only ourselves but also help others to learn so that one day the information-based Bangladesh will be formed, it is a strong bonded from Backdoor. |
| [KrystianD/MikrotikAPI.NET](https://github.com/KrystianD/MikrotikAPI.NET) | 0 | 0 | 📝: Low-level connector for Mikrotik API for .NET. |
| [andy-68/dci5-mikrot-ssh](https://github.com/andy-68/dci5-mikrot-ssh) | 0 | 0 | 📝: This is a module to allow DCI5 works with Mikrotik switches via ssh protocol.  |
| [ruanSignori/redes](https://github.com/ruanSignori/redes) | 0 | 0 | 📝: Anotações sobre protocolos e serviços de Redes, Infra e Comandos |
| [litew/mikrotik-yggdrasil-go](https://github.com/litew/mikrotik-yggdrasil-go) | 0 | 1 | 📝: Yggdrasil-go for MikroTik routers |
| [ondras12345/mikrotik-ssh-backup](https://github.com/ondras12345/mikrotik-ssh-backup) | 0 | 0 | 📝: Automatically create binary backups and configuration exports of Mikrotik RouterOS devices via SSH |
...
| [ns-88/RouterControl](https://github.com/ns-88/RouterControl) | 0 | 0 | 📝: Router control program. |
| [leechunyen/MikroTik-Script](https://github.com/leechunyen/MikroTik-Script) | 0 | 0 | 📝: No description |
| [nymurbd/Mikrotik-Switch](https://github.com/nymurbd/Mikrotik-Switch) | 0 | 0 | 📝: Turn your Mikrotik router in to a switch . |
