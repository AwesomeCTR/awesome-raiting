# Awesome Repositories Topic: flipper-zero
...
| [K3YOMI/Wall-of-Flippers](https://github.com/K3YOMI/Wall-of-Flippers) | 762 | 56 | 📝: A simple and easy way to find Flipper Zero Devices and Bluetooth Low Energy Based Attacks |
...
| [Drew-Alleman/powershell-backdoor-generator](https://github.com/Drew-Alleman/powershell-backdoor-generator) | 332 | 58 | 📝: Reverse backdoor written in PowerShell and obfuscated with Python. It generates payloads for popular hacking devices like Flipper Zero and Hak5 USB Rubber Ducky, and changes its signature after every build to help avoid AV. |
...
| [h-RAT/EvilCrowRF_Custom_Firmware_CC1101_FlipperZero](https://github.com/h-RAT/EvilCrowRF_Custom_Firmware_CC1101_FlipperZero) | 277 | 27 | 📝: This firmware is an alternative to the EvilCrowRF default firmware. Module: CC1101 - Compatible Flipper Zero file. |
...
| [dsymbol/ducky-payloads](https://github.com/dsymbol/ducky-payloads) | 19 | 2 | 📝: A collection of 🦆 payloads compatible with hak5-RubberDucky, FlipperZero-BadUSB & pico-ducky.  |
...
| [GEMISIS/tone_gen](https://github.com/GEMISIS/tone_gen) | 4 | 2 | 📝: Very simple tone generator application for the Flipper Zero. Setup to be a good sample project as well. |
...
| [jagerbob/flipper](https://github.com/jagerbob/flipper) | 0 | 0 | 📝: A repository containing my experimentations with the Flipper Zero |
